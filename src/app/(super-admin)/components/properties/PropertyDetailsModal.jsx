            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
              <div className="lg:col-span-2 space-y-6 md:space-y-8">
                ...
                <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200 overflow-x-auto">
                  <h3 className="text-xs md:text-sm font-bold uppercase tracking-wider text-gray-400 mb-4 md:mb-6">
                    ...
                    {verificationSteps.map((step, index) => (
                      ...
                      >
                        <div className="flex flex-col items-center gap-2">
                          ...
                          <span
                            className={`text-xs font-medium ${index <= statusIndex ? "text-green-700" : "text-gray-400"}`}
                          >
                            {step.label}
                          </span>
                        </div>
                        {index < verificationSteps.length - 1 && (
                          <div
                            className={`flex-1 h-0.5 mx-2 md:mx-4 ${index < statusIndex ? "bg-green-600" : "bg-gray-200"}`}
                          ></div>
                        )}
                      </div>
                    ))}
                      ...
                      <div className="space-y-3 text-sm">
                        <div className="flex justify-between border-b pb-2">
                          ...
                          <span className="font-medium text-right">
                            {currentFinanceLegal.finance.bankDetails.bankName}
                          </span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                        ...
                        <div className="flex justify-between border-b pb-2">
                          ...
                          <span className="font-mono font-medium">
                            {currentFinanceLegal.finance.bankDetails.ifscCode}
                          </span>
                        </div>
                      </div>
                    ) : (
                    ...
                    {currentFinanceLegal?.finance?.taxDetails ? (
                      <div className="space-y-3 text-sm">
                        <div className="flex justify-between border-b pb-2">
                          ...
                          <span className="font-mono font-medium">
                            {currentFinanceLegal.finance.taxDetails.pan}
                          </span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                          <span className="text-gray-500">GSTIN</span>
                          <span className="font-medium">
                            {currentFinanceLegal.finance.taxDetails.gstin ||
                              "N/A"}
                          </span>
                        </div>
                        <div className="flex justify-between border-b pb-2">
                          ...
                          <span className="font-medium">
                            {currentFinanceLegal.finance.taxDetails.tan ||
                              "N/A"}
                          </span>
                        </div>
                      </div>
                ...
                <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200">
                  <div className="flex flex-wrap items-center justify-between mb-4 gap-3">
                    ...
                    {currentFinanceLegal?.legal?.ownershipDetails
                ...
                <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4">
                    {availableAmenities.map((name) => (
                      <div
                        key={name}
                        className="flex items-center gap-2 md:gap-3 p-2 md:p-3 bg-gray-50 rounded-lg border border-gray-100"
                      >
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200 shadow-sm">
                  <h3 className="text-xs md:text-sm font-bold uppercase tracking-wider text-gray-400 mb-3 md:mb-4">
                    Location
                  </h3>
                ...
                <div className="bg-blue-600 p-4 md:p-6 rounded-xl text-white shadow-lg">
                  <h3 className="text-[10px] md:text-xs font-bold uppercase tracking-widest opacity-70 mb-4">
                    Registered Partner
                  </h3>
                  {isUserLoading ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2 border-t border-blue-400 pt-4 text-xs md:text-sm">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {selectedUser.phoneNumber || property.mobileNumber}
                        </div>
                      </div>
                    </div>
                  ) : (
                  ...
                  <div className="space-y-3 pb-6 sm:pb-0">
                    {property.status?.toLowerCase() === "published" ? (
                      <>
                        ...
                        >
                          <FileEdit className="w-4 md:w-5 h-4 md:h-5" />{" "}
                        ...
                        >
                          <XIcon className="w-4 md:w-5 h-4 md:h-5" /> Reject
                          Property
                        </button>
                      </>
                      ...
                      <>
                        ...
                        >
                          <Check className="w-4 md:w-5 h-4 md:h-5" /> Approve &
                          Publish
                        </button>
                        <button
                          onClick={() => {
                            setReviewAction("draft");
                            setShowReviewPopup(true);
                          }}
                        ...
                        >
                          <FileEdit className="w-4 md:w-5 h-4 md:h-5" /> Move to
                          Draft
                        </button>
                      </>
                    ) : (
      ...
      {showReviewPopup && (
        <div className="fixed inset-0 bg-[#0000004f] backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-white rounded-2xl p-6 md:p-8 max-w-lg w-full text-center shadow-2xl">
            <div
              className={`w-14 md:w-16 h-14 md:h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${
            ...
            >
              {reviewAction === "approve" ? (
                <Check className="w-6 md:w-8 h-6 md:h-8" />
              ) : reviewAction === "reject" ? (
                <XIcon className="w-6 md:w-8 h-6 md:h-8" />
              ) : (
                <FileEdit className="w-6 md:w-8 h-6 md:h-8" />
              )}
            </div>
            ...
            <p className="text-xs md:text-sm text-gray-500 mb-4">
              ...
              {reviewAction === "draft" &&
                " This will allow the host to edit the property details again."}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="flex-1 py-2.5 md:py-3 border border-gray-300 rounded-lg font-bold text-gray-600 hover:bg-gray-50 text-sm md:text-base"
              >
                Cancel
              </button>
              <button
