  ...
  return (
    <Box>
           ...
           <AccordionSummary expandIcon={<ExpandMore />}>
            ...
            <AccordionDetails>
              <Box sx={{ mb: 3, display: 'flex', justifyContent: 'flex-end' }}>
                ...
                <Button variant="contained" sx={{ bgcolor: '#1035ac', color: 'white', '&:hover': { bgcolor: '#0c2780' } }} startIcon={<CloudUpload />} onClick={() => fileInputRefs.current[room._id]?.click()} disabled={isLoading}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 4 }}>
        ...
        <Button variant="contained" sx={{ bgcolor: '#1035ac', color: 'white', '&:hover': { bgcolor: '#0c2780' } }} onClick={handleCompleteStep}>Save & Continue</Button>
      </Box>
          ...
          {editingMedia && (
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                ...
                <ResponsiveTextField fullWidth size="small" placeholder="Add custom tag" value={customTag} onChange={(e) => setCustomTag(e.target.value)} onKeyPress={(e) => { if (e.key === 'Enter') addCustomTag(); }} sx={{ mb: 2 }} InputProps={{ startAdornment: <Search sx={{ mr: 1, color: 'text.secondary' }} /> }} />
